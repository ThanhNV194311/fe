    ...
    <div className="admin-create">
      ...
      {detailProduct ? (
        ...
        >
          ...
          <input
            {...register("ram")}
            defaultValue={detailProduct.ram}
            placeholder="Ram"
            type="number"
          ></input>
          ...
          <input
            ...
            placeholder="Bộ nhớ"
            type="number"
            defaultValue={detailProduct.rom}
          ></input>
          <input
            {...register("screen")}
            placeholder="Màn hình"
            type="text"
            defaultValue={detailProduct.screen}
          ></input>
          <input
            {...register("camera")}
            placeholder="Camera"
            type="text"
            defaultValue={detailProduct.camera}
          ></input>
          <input
            {...register("battery")}
            placeholder="Pin"
            type="text"
            defaultValue={detailProduct.battery}
          ></input>
          <input
            {...register("special")}
            placeholder="Hệ điều hành"
            type="text"
            defaultValue={detailProduct.special}
          />
