		...
		<div className="admin-create">
			...
			>
				...
				<input
					...
					type="number"
				></input>
				<input {...register("ram")} placeholder="Ram" type="number"></input>

				<input {...register("rom")} placeholder="Bộ nhớ" type="number"></input>
				<input
					{...register("screen")}
					placeholder="Màn hình"
					type="text"
				></input>
				<input {...register("camera")} placeholder="Camera" type="text"></input>
				<input {...register("battery")} placeholder="Pin" type="text"></input>
				<input
					{...register("special")}
