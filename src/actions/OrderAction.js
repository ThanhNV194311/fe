...
export const createOrder = order => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.post(
			"https://be-production-05ac.up.railway.app/order/create",
			order,
			{
				headers: {
...
export const cancelOrder = orderId => async (dispatch, getState) => {
	try {
		const { data } = await axios.post(
			`https://be-production-05ac.up.railway.app/order/cancel/${orderId}`
		);
...
export const getAllOrder = () => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.get(
			`https://be-production-05ac.up.railway.app/order/`,
			{
				headers: {
					Authorization: `Bearer ${userInfo.token}`,
				},
...
//       userSignin: { userInfo },
//     } = getState();
//     const { data } = await axios.get(`https://be-production-05ac.up.railway.app/order/orderPaypal`, {
//       headers: {
//         Authorization: `Bearer ${userInfo.token}`,
//       },
//     });
...
export const GetAllOrderPendding = () => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.get(
			`https://be-production-05ac.up.railway.app/order/orderPendding`,
			{
				headers: {
					Authorization: `Bearer ${userInfo.token}`,
				},
...
export const GetAllOrderShipping = () => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.get(
			`https://be-production-05ac.up.railway.app/order/orderShipping`,
			{
				headers: {
					Authorization: `Bearer ${userInfo.token}`,
				},
...
export const GetAllOrderPaid = () => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.get(
			`https://be-production-05ac.up.railway.app/order/orderPaid`,
			{
				headers: {
					Authorization: `Bearer ${userInfo.token}`,
				},
...
export const deleteOrder = orderId => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.delete(
			`https://be-production-05ac.up.railway.app/order/delete/${orderId}`,
			{
				headers: {
					Authorization: `Bearer ${userInfo.token}`,
				},
...
export const ShippingOrder = orderId => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.put(
			`https://be-production-05ac.up.railway.app/order/shipping/${orderId}`,
			{
				headers: {
					Authorization: `Bearer ${userInfo.token}`,
				},
...
export const PaidOrder = orderId => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.put(
			`https://be-production-05ac.up.railway.app/order/paid/${orderId}`,
			{
				headers: {
					Authorization: `Bearer ${userInfo.token}`,
				},
...
export const getOrderByUser = idUser => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.get(
			`https://be-production-05ac.up.railway.app/order/${idUser}`,
			{
				headers: {
					Authorization: `Bearer ${userInfo.token}`,
				},
...
export const getOrderPenddingByUser = idUser => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.get(
			`https://be-production-05ac.up.railway.app/order/orderPendding/${idUser}`,
			{
				headers: {
					Authorization: `Bearer ${userInfo.token}`,
				},
...
export const getOrderShippingByUser = idUser => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.get(
			`https://be-production-05ac.up.railway.app/order/orderShipping/${idUser}`,
			{
				headers: {
					Authorization: `Bearer ${userInfo.token}`,
				},
...
export const getOrderPaidByUser = idUser => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.get(
			`https://be-production-05ac.up.railway.app/order/orderPaid/${idUser}`,
			{
				headers: {
					Authorization: `Bearer ${userInfo.token}`,
				},
	...
	(order, paymentResult) => async (dispatch, getState) => {
		...
		try {
			const { data } = axios.put(
				`https://be-production-05ac.up.railway.app/order/pay/${order._id}`,
				paymentResult,
				{
